...
## Authorization healthcheck and webhook stabilization qualification

Stage: `1D-R3`

Current applied MatrixRTC upgrade state:

```text
docker_compose_hash=56d2ab22fbd1ca9d7b591ffa116511fbb18da18538f35ecfeba8d7c01a528ecb
livekit_hash=02cfdbbedb79f25fe4a0aa4e02526692d70b690d2056b240116b97017b9eba91
synapse_matrixrtc_hash=5d8dabe72a6da5d5c0ca122e758553b0161d1e28776dc62760230f08f6e22444
authorization_image=salemx/lk-jwt-service:ac7d0de49060b0cabe25925c4b671d5e8f637567
authorization_direct_healthz_status=200
authorization_docker_health=unhealthy
salem_invite_post_status=401
salem_stream_get_status=401
salem_dev_invite_post_status=404
```

Confirmed healthcheck defect:

```text
defect=healthcheck_treats_LIVEKIT_JWT_BIND_as_bare_port
configured_bind=127.0.0.1:8090
broken_healthcheck_url=http://localhost:127.0.0.1:8090/healthz
actual_service_health_url=http://127.0.0.1:8090/healthz
```

Healthfix patch scope:

```text
source_base_commit=ac7d0de49060b0cabe25925c4b671d5e8f637567
source_worktree=/tmp/salemx-lk-jwt-service-healthfix1
modified_files=healthcheck/main.go,healthcheck/main_test.go
main_service_bind_semantics_changed=false
healthcheck_loopback_target=127.0.0.1
wildcard_bind_connects_to_loopback=true
malformed_bind_rejected=true
```

Validation:

```text
go_test_timeout_30s=pass
go_test_all=pass
go_vet_all=pass
golangci_lint=pass
cargo_test_locked=pass
go_mod_unchanged=true
go_sum_unchanged=true
only_healthcheck_files_changed=true
```

Healthfix image:

```text
image=salemx/lk-jwt-service:ac7d0de49060b0cabe25925c4b671d5e8f637567-healthfix1
platform=linux/amd64
engine_native_id=sha256:9dab45e9a8b4a4ee5d08b90275ada1bcc5990c0a7d29eea4aba7c608d92ce881
config_digest=sha256:4b59f1756fb74984460bb10a42aaf59ffe9e494285c7f3d0a9f385b06c0659bd
manifest_digest=sha256:fbc7db46a23157e562d61959121799b80122f34d40ec4f13635e5cb6d76602e8
index_digest=sha256:9dab45e9a8b4a4ee5d08b90275ada1bcc5990c0a7d29eea4aba7c608d92ce881
index_json_digest=sha256:b70a7aa19920c7d118375d8e3743c2b7c6c84c7c5214f5e9f99fe91ae7cc018e
archive=/tmp/salemx-lk-jwt-service-ac7d0de49060b0cabe25925c4b671d5e8f637567-healthfix1.tar
archive_sha256=701b3b4e4b147257be0fe135b9b7e58ab3d24137b9970ed49610978822c6b120
manifest=/tmp/salemx-lk-jwt-service-ac7d0de49060b0cabe25925c4b671d5e8f637567-healthfix1.manifest.txt
manifest_sha256=aab1c750ca8b298e1ce7a9a8798e2dc9e32fea6f87b7389508c3371c435b76d8
local_smoke_bind_127_0_0_1_18090=healthy
local_smoke_bind_colon_18091=healthy
...
```text
active_site_file=/etc/nginx/sites-enabled/matrix.mertis.kz
active_site_hash=2950387b8d54425f40b8cc19c99591b6cffe16d88245ab643a02a25033474e84
active_snippet_file=/etc/nginx/snippets/livekit-jwt-compat.conf
active_snippet_hash=6d1f22ce6a71fc89dff59c08bc6e18d94efba0a18364f14d96d84c7ab15431b2
sfu_get_public_route=location_exact_/livekit/jwt/sfu/get
sfu_get_upstream=http://127.0.0.1:8090/sfu/get
sfu_webhook_public_route_present=false
public_webhook_404_cause=missing_allowlisted_exact_nginx_location
required_webhook_upstream=http://127.0.0.1:8090/sfu_webhook
```

Stabilization status:

```text
script=/tmp/salemx_matrixrtc_authorization_stabilization.sh
script_sha256=e9d1b370b82028c90be43b81b28ff23902e444ebd19f8af8b57f9131b0ce33b1
prepared_not_executed=true
authorized_compose_change=authorization_image_tag_only
authorized_nginx_change=add_exact_webhook_proxy_route_only
synapse_restart=false
livekit_recreate=false
redis_restart=false
call_service_restart=false
registry_pull=false
server_stabilization_executed=false
```

## MatrixRTC stabilization final acceptance

Stage: `1D-R4`

Recorded stabilization result:

```text
STABILIZATION_COMPLETE=true
stabilization_pipeline_rc=0
rollback_attempted=false
authorization_container_running=true
authorization_container_health=healthy
authorization_healthz_status=200
authorization_sfu_get_route_exists=true
authorization_internal_webhook_route_exists=true
authorization_public_webhook_route_exists=true
authorization_redis_remains_configured=true
authorization_sanity_interval_remains_60=true
livekit_webhook_configuration_remains_unchanged=true
synapse_rate_limits_remain_configured=true
prepared_metadata_created=false
invite_dispatched=false
APNs_sent=false
foreground_stream_opened=false
matrix_event_created=false
media_connected=false
livekit_room_created=false
```

Current authorization image:
...
Fresh read-only endpoint acceptance:

```text
authorization_healthz_status=200
authorization_internal_sfu_get_status=405
authorization_public_sfu_get_status=405
authorization_internal_webhook_post_status=200
authorization_public_webhook_post_status=200
redis_host_loopback_ping=true
```

Fresh unauthenticated Salem route contract:

```text
salem_invite_post_status=401
salem_invite_get_status=405
salem_stream_get_status=401
salem_stream_post_status=405
salem_dev_invite_get_status=404
salem_dev_invite_post_status=404
salem_contract_preserved=true
```

External exposure check from outside the server:

```text
external_redis_6379_closed=true
external_livekit_http_7880_closed=true
external_authorization_8090_closed=true
```

Nginx duplicate server-name warning audit:

```text
duplicate_warning_80=true
duplicate_warning_443=true
selected_matrix_server_file=/etc/nginx/sites-enabled/matrix.mertis.kz
selected_matrix_server_file_sha256=2950387b8d54425f40b8cc19c99591b6cffe16d88245ab643a02a25033474e84
ignored_duplicate_file=/etc/nginx/sites-enabled/matrix.mertis.kz.bak-salemx-foreground-signaling
ignored_duplicate_file_sha256=d2aa0e423dcae5e4e554be77edc5b31bfc3052977b6d2fc9f3a14755d9a94ccb
livekit_jwt_snippet=/etc/nginx/snippets/livekit-jwt-compat.conf
livekit_jwt_snippet_sha256=c54061cd46bc710634a07712def42f07578ec4802c0b8a0b81d0da70e8367b99
selected_block_has_sfu_get=true
selected_block_has_sfu_webhook=true
duplicate_affects_matrixrtc_routes=false
duplicate_pre_existing=true
nginx_duplicate_server_name_severity=cleanup_recommended
blocks_reference_call=false
```

The warning comes from an enabled backup vhost that repeats `server_name matrix.mertis.kz` on ports `80` and `443`. The selected vhost is the primary `matrix.mertis.kz` file and includes the MatrixRTC JWT snippet containing both `/livekit/jwt/sfu/get` and `/livekit/jwt/sfu_webhook`, so the duplicate does not block the upstream reference-call test. Cleanup is recommended in a separate nginx hygiene stage.

Prepared upstream reference-call acceptance:

```text
preflight_script=/tmp/salemx_matrixrtc_reference_call_preflight.sh
preflight_script_sha256=1331ac5514eb42d35416e8f5f3f406d6884ae48ee1ee7f12859512a37b632dfa
postcheck_script=/tmp/salemx_matrixrtc_reference_call_postcheck.sh
postcheck_script_sha256=1b5fb3335a4fa20ee64ec223a5fb685be389b15913770404dfa94083b7ef6565
scripts_not_executed=true
reference_call_executed=false
reference_call_scope=standard_upstream_element_call_matrixrtc
salem_foreground_invite_used=false
APNs_sent=false
custom_ios_livekit_path_used=false
camera_permission_required=false
```

Reference-call acceptance to be proven by the prepared scripts after the operator performs one first call, ends it, then performs one immediate second call:

```text
first_call_room_created=true
first_call_two_participants_seen=true
participant_join_webhook_seen=true
participant_leave_webhook_seen=true
redis_job_created=true
redis_job_cleaned=true
...
```text
server_acceptance_passed=true
authorization_healthy=true
public_webhook_route_present=true
external_redis_closed=true
external_livekit_http_closed=true
external_authorization_closed=true
salem_contract_preserved=true
nginx_warning_classified=true
reference_preflight_script_created=true
reference_postcheck_script_created=true
scripts_not_executed=true
runtime_code_changed=false
server_changed=false
