...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func debugVoIPPushReceiptProofRequestsControlledCallKitReportOnly() throws {
        ...
        #expect(adapterSource.contains("let completeOnce: (String, String) -> Void"))
        #expect(adapterSource.contains("completeOnce(\"timeout_redacted\", \"callkit_report_completion_timeout_redacted\")"))
        #expect(adapterSource.contains("completeOnce(reportResult, blockedReason)"))
        ...
        let reportFinalizer = try #require(adapterSource.range(of: "completeOnce(reportResult, blockedReason)")?.lowerBound)
