...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func realInviteAnswerProofRecordsForegroundPendingCallStateOnly() throws {
        ...
        #expect(adapterSource.contains("mediaConnectBlockedReason = mediaConnectPreflightCredentialsAvailable ? \"controlled_preflight_no_connect\" : \"media_connect_preflight_not_ready\""))
