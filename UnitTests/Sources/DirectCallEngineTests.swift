...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func receiverAudioPublishGateIsDebugOnlyAndRequiresConnectedAnswerBeforeMicrophone() throws {
        ...
        #expect(source.contains("summary.recordReceiverAudioPublishFunctionEntered(ready: true)"))
        #expect(source.contains("summary.recordReceiverAudioPublishRequestDispatched()"))
        ...
        #expect(adapterSource.contains("mutating func recordReceiverAudioPublishFunctionEntered(ready: Bool)"))
        #expect(adapterSource.contains("mutating func recordReceiverAudioPublishRequestDispatched()"))
