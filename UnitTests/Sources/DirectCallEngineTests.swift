...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func debugVoIPPushReceiptProofRequestsControlledCallKitReportOnly() throws {
        ...
        #expect(adapterSource.contains("let completeOnce: (String, String, NativeIncomingSyntheticCallKitUIAnswerRetentionProof?) -> Void"))
        #expect(adapterSource.contains("completeOnce(\"timeout_redacted\", \"callkit_report_completion_timeout_redacted\", nil)"))
        #expect(adapterSource.contains("completeOnce(reportResult, blockedReason, answerRetentionProof)"))
        ...
        let reportFinalizer = try #require(adapterSource.range(of: "completeOnce(reportResult, blockedReason, answerRetentionProof)")?.lowerBound)
    ...
    func controlledCallKitReportWaitsForCallbackAndRecordsAnswerMatchingProof() throws {
        ...
        #expect(adapterSource.contains("local_callkit_only_report_requested=\\(localCallKitOnlyReportRequested)"))
        #expect(adapterSource.contains("local_callkit_only_report_result=\\(localCallKitOnlyReportResult)"))
        #expect(adapterSource.contains("local_callkit_only_first_action_kind=\\(localCallKitOnlyFirstActionKind)"))
        #expect(adapterSource.contains("local_callkit_only_answer_action_delivered=\\(localCallKitOnlyAnswerActionDelivered)"))
        #expect(adapterSource.contains("local_callkit_only_end_action_delivered=\\(localCallKitOnlyEndActionDelivered)"))
        ...
        #expect(adapterSource.contains("startLocalCallKitOnlyAnswerabilitySmoke()"))
        #expect(adapterSource.contains("SalemXLocalCallKitOnlyProofEventRecorder"))
        #expect(adapterSource.contains("recordLocalCallKitOnlyReportResult(\"reported\")"))
        #expect(adapterSource.contains("recordLocalCallKitOnlyAnswerActionDeliveryProof(generationMatched: generationMatched)"))
        #expect(adapterSource.contains("recordLocalCallKitOnlyEndActionDeliveryProof(generationMatched: generationMatched)"))
        #expect(adapterSource.contains("local_callkit_only_waiting_for_action"))
    ...
    func realInviteAnswerProofRecordsForegroundPendingCallStateOnly() throws {
        ...
        #expect(adapterSource.contains("mediaCredentialsResult = \"planned_redacted\""))
