...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func remoteParticipantPresenceRepairClassifiesSenderReadinessAndReceiverObserverSafely() throws {
        ...
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitReadinessMatrixSessionReady = remotePeerContextHandoffReceivedByRuntime"))
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitReadinessSameRoomReady = productionLikeTwoPhysicalDeviceProof && remotePeerContextHandoffReceivedByRuntime"))
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitReadinessCredentialsReady = false"))
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitJoinPathDefaultDisabled = true"))
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitJoinPathAudioOnly = true"))
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitJoinPathVideoAllowed = false"))
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitJoinPathMatrixEventsAllowed = false"))
        #expect(adapterSource.contains("secondPhysicalSenderLiveKitJoinPathRawCredentialsLogged = false"))
        ...
        #expect(adapterSource.contains("receiverRemoteParticipantObserverResult = \"success_redacted\""))
        #expect(adapterSource.contains("receiverRemoteParticipantObserverErrorBucket = \"none\""))
        #expect(adapterSource.contains("receiverRemoteParticipantObserverErrorBucket = \"remote_audio_track_missing_redacted\""))
        #expect(adapterSource.contains("receiverRemoteParticipantObserverErrorBucket = \"remote_liveness_not_observed_redacted\""))
        #expect(adapterSource.contains("receiverRemoteParticipantObserverErrorBucket = \"sender_not_joined_or_remote_missing_redacted\""))
    ...
    func physical6RuntimeEnablementHookArmsOneShotWithoutSideEffects() throws {
        ...
        #expect(adapterSource.contains("if url.path == physical6RuntimeEnablementURLHookPath"))
