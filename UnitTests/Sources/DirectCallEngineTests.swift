...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func senderSideLiveKitJoinActivationIsDebugOnlyOneShotAndClassifiedWithoutRuntime() throws {
        ...
        #expect(adapterSource.contains("finalErrorBucket = joinDiagnostics.errorBucket"))
        ...
        #expect(adapterSource.contains("finalErrorBucket = joinDiagnostics.errorBucket == \"none\" ? \"none\" : joinDiagnostics.errorBucket"))
