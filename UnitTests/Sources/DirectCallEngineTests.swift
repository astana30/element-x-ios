...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func debugVoIPPushReceiptProofRequestsControlledCallKitReportOnly() throws {
        ...
        let timeoutFallback = try #require(adapterSource.range(of: "timeout_redacted")?.lowerBound)
        ...
        #expect(adapterSource.contains("callkit_report_completion_timeout_redacted"))
    ...
    func controlledCallKitReportWaitsForCallbackAndRecordsAnswerMatchingProof() throws {
        ...
        #expect(adapterSource.contains("callKitReportCompletionObserved = reportResult != \"timeout_redacted\""))
    ...
    func controlledCallKitBackgroundTimingProofIsRedactedAndBucketed() throws {
        ...
        #expect(adapterSource.contains("completionCoordinator.shouldRunReportTimeout()"))
        ...
        #expect(adapterSource.contains("pushKitCompletionDate = reportResult == \"timeout_redacted\" ? nil : completionCallDate"))
    ...
    func realInviteAnswerProofRecordsForegroundPendingCallStateOnly() throws {
        ...
        #expect(adapterSource.contains("await requestControlledMediaCredentialsNoConnect(session: session, source: \"authenticated_pending_metadata_fetch\")"))
        #expect(adapterSource.contains("private static func requestControlledMediaCredentialsNoConnect(session: DirectCallSession, source: String) async"))
        ...
        #expect(adapterSource.contains("recordControlledConnectActivationProof(SalemXControlledMediaConnectActivationConfiguration.defaultDisabled)"))
        #expect(adapterSource.contains("recordControlledConnectEnablementProof(SalemXControlledMediaConnectEnablementConfiguration.defaultDisabled)"))
        #expect(adapterSource.contains("mediaConnectExecutionAllowed = controlledConnectExecutionAllowed && controlledConnectEnablementExecutionAllowed"))
        #expect(adapterSource.contains("recordControlledAudioConnectExecutionGate(SalemXControlledAudioConnectExecutionGate(credentialsPresent: mediaConnectPreflightCredentialsAvailable"))
        #expect(adapterSource.contains("mediaConnectExecutionAllowed = mediaConnectExecutionAllowed && controlledAudioConnectExecutionAllowed"))
        #expect(adapterSource.contains("mediaConnectPreflightResult = mediaConnectPreflightCredentialsAvailable ? \"blocked_before_connect_redacted\" : \"blocked_redacted\""))
    ...
    func controlledConnectSwitchDefaultsDisabledAndBlocksBeforeSideEffects() throws {
        ...
        #expect(adapterSource.contains("matrix_event_emit_requested=false"))
        #expect(adapterSource.contains("real_call_flow_started=false"))
        #expect(!adapterSource.contains("connectMediaIfReady("))
    ...
    func controlledAudioConnectFirstAttemptFakeBoundaryRequiresAllGatesAndNoRealMedia() throws {
        ...
        #expect(firstAttemptSource.contains("enablementConfiguration.executionAllowed"))
        #expect(firstAttemptSource.contains("executionGate.executionAllowed"))
        #expect(firstAttemptSource.contains("activationPath.activationAllowed"))
        ...
        #expect(adapterSource.contains("recordControlledAudioConnectFirstAttemptProof(.fakeBoundaryForTests(enablementConfiguration: enablementConfiguration"))
    ...
    func controlledAudioConnectActivationPathDefaultsDisabledBeforeSideEffects() throws {
        ...
        #expect(adapterSource.contains("recordControlledAudioConnectActivationPath(SalemXControlledAudioConnectActivationPath(receiverAppSessionValidated: pendingMetadataFetchAuthorized && pendingMetadataFetchResult == \"success_redacted\""))
        #expect(adapterSource.contains("mediaConnectExecutionAllowed = mediaConnectExecutionAllowed && controlledAudioConnectActivationAllowed"))
