...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func senderSideLiveKitJoinActivationIsDebugOnlyOneShotAndClassifiedWithoutRuntime() throws {
        ...
        #expect(adapterSource.contains("finalResult = requestedResult"))
        #expect(adapterSource.contains("finalResult = SalemXSenderSideLiveKitJoinHook.notRequestedResult"))
        #expect(adapterSource.contains("finalErrorBucket = diagnostics.errorBucket"))
        #expect(adapterSource.contains("finalErrorBucket = diagnostics.errorBucket == \"none\" ? SalemXSenderSideLiveKitJoinActivation.senderReadinessMissingReason : diagnostics.errorBucket"))
        #expect(adapterSource.contains("finalErrorBucket = diagnostics.errorBucket == \"none\" ? SalemXSenderSideLiveKitJoinActivation.sameRoomReadinessMissingReason : diagnostics.errorBucket"))
        #expect(adapterSource.contains("finalErrorBucket = diagnostics.errorBucket == \"none\" ? \"none\" : diagnostics.errorBucket"))
    ...
    func senderJoinFailureDiagnosticsClassifyRedactedBucketsWithoutRuntime() throws {
        ...
        #expect(adapterSource.contains("diagnostics.blocksBeforeTransport"))
        #expect(adapterSource.contains("summary.recordSenderJoinFailureDiagnostics(diagnostics)"))
