...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func realInviteAnswerProofRecordsForegroundPendingCallStateOnly() throws {
        ...
        #expect(adapterSource.contains("mediaConnectBlockedReason = mediaConnectPreflightCredentialsAvailable ? controlledConnectBlockedReason : \"media_connect_preflight_not_ready\""))
