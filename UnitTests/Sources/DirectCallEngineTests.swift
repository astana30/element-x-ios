...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func senderSideLiveKitJoinActivationIsDebugOnlyOneShotAndClassifiedWithoutRuntime() throws {
        ...
        #expect(adapterSource.contains("finalErrorBucket = \"sender_join_repeated_redacted\""))
        #expect(adapterSource.contains("finalErrorBucket = SalemXSenderSideLiveKitJoinActivation.senderReadinessMissingReason"))
        #expect(adapterSource.contains("finalErrorBucket = SalemXSenderSideLiveKitJoinActivation.sameRoomReadinessMissingReason"))
        #expect(adapterSource.contains("requestedResult == SalemXSenderSideLiveKitJoinHook.failedResult ? \"sender_join_failed_redacted\" : \"none\""))
