...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func remoteParticipantObservationTimingRepairRetainsReceiverUntilRuntimeTerminal() throws {
        ...
        #expect(adapterSource.contains("sender_connected_signal_received_redacted"))
        ...
        #expect(adapterSource.contains("participant_event_timeout_after_sender_signal_redacted"))
        ...
        #expect(adapterSource.contains("receiverSenderConnectedSignalFinalClassification = \"sender_connected_signal_received_redacted\""))
        ...
        #expect(adapterSource.contains("scheduleRemoteParticipantObservationTimeoutIfNeeded()"))
        #expect(adapterSource.contains("return \"participant_event_timeout_after_sender_signal_redacted\""))
    ...
    func senderRuntimeLiveKitJoinBridgeUsesRuntimeCallbacksNotQueryOutcomes() throws {
        ...
        #expect(referenceHandoffSource.contains("summary.markReferenceHandoff(handoff)"))
