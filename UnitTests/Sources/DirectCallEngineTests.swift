...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func remoteParticipantPresenceRepairClassifiesSenderReadinessAndReceiverObserverSafely() throws {
        ...
        #expect(adapterSource.contains("receiverRemoteParticipantObserverErrorBucket = \"sender_readiness_context_missing_redacted\""))
        #expect(adapterSource.contains("receiverRemoteParticipantObserverErrorBucket = \"sender_not_joined_redacted\""))
        #expect(adapterSource.contains("receiverRemoteParticipantObserverErrorBucket = \"remote_participant_missing_redacted\""))
