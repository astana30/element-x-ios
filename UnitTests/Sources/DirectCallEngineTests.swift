...
final class NativeIncomingCallLifecycleContractTests {
    ...
    func remoteParticipantObservationTimingRepairRetainsReceiverUntilRuntimeTerminal() throws {
        ...
        #expect(adapterSource.contains("\"remote_audio_explicit_subscription_success_redacted\""))
        ...
        #expect(remoteAudioClassificationSource.contains("\"remote_audio_publication_missing_redacted\""))
