...
extension CallScreenViewModelTests {
    ...
    func appStoreLinePresentsIncomingCallsFromMatrixRTCPresence() throws {
        ...
        #expect(appCoordinator.contains("native-audio-early-keys native-audio-peer-device-key native-audio-buffer-keys native-audio-local-key-wait native-audio-skip-chrome native-audio-key-error-log virtual-earpiece-default pushkit-token-hex sandbox-apns-activation message-pusher-dev mertis-push-gateway pushkit-callkit-first"))
