...
Next, continue with `2.39U — post-pilot hardening workstream selection` to choose the first implementation workstream from foreground UX polish, monitoring automation, CallKit/push/background incoming planning, audio controls polish, or a later additional soak after hardening. Broad internal rollout, production/public rollout, unsupervised dogfood, participant/device expansion, CallKit/push implementation in this phase, missed-call UX, video, session restoration, and global activation remain blocked.
