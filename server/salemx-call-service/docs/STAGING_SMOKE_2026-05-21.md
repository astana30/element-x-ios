...
Next, continue with `2.39X — operational monitoring automation design` to define the redacted monitoring contract, alert-worthy states, incident correlation strategy, tests, and runtime proof needed before implementing monitoring automation. Broad internal rollout, production/public rollout, unsupervised dogfood, participant/device expansion, CallKit/push implementation in this phase, missed-call UX, video, session restoration, and global activation remain blocked.
