...
Next, continue with `2.39E — narrow non-engineering pilot execution approval re-review` only after the blocker-remediation checklist is filled. Broad internal rollout, production/public rollout, CallKit, push/background incoming, missed-call UX, video, session restoration, and global activation remain blocked.
