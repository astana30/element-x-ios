...
Next, continue with `2.39S — post-window 3 non-engineering pilot review` to decide what the clean 2.39R window proves and whether execution should pause for product/operational hardening or any further supervised window can be considered. Broad internal rollout, production/public rollout, unsupervised dogfood, participant/device expansion, CallKit, push/background incoming, missed-call UX, video, session restoration, and global activation remain blocked.
