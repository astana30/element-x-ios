...
private struct SalemXSenderRuntimeLiveKitJoinProofSummary {
    ...
    var senderDebugPendingMetadataFileHandoffSeen = false
    var senderDebugPendingMetadataFileHandoffShapeBucket = "none"
    var senderDebugPendingMetadataFileHandoffConsumed = false
    ...
    var appClaimRequestStarted = false
    var appClaimRequestURLBucket = "missing"
    var appClaimAuthSchemeBucket = "missing"
    var appClaimAuthTokenBucket = "missing"
    var appClaimAuthSourceBucket = "missing"
    var appClaimHTTPStatusBucket = "not_requested"
    var serverClaimAuthHeaderSeen = false
    var serverClaimAuthSchemeBucket = "missing"
    var serverClaimTokenValidationBucket = "not_reached"
    var serverClaimAuthenticatedUserBucket = "not_reached"
    ...
    var senderLocalAudioPublishRequested = false
    ...
    var senderPendingMetadataMemoryReferencePresent: Bool {
    ...
    var redactedLines: [String] {
        [
            ...
            "sender_debug_pending_metadata_file_handoff_seen=\(senderDebugPendingMetadataFileHandoffSeen)",
            "sender_debug_pending_metadata_file_handoff_shape_bucket=\(senderDebugPendingMetadataFileHandoffShapeBucket)",
            "sender_debug_pending_metadata_file_handoff_consumed=\(senderDebugPendingMetadataFileHandoffConsumed)",
            "sender_debug_pending_metadata_file_handoff_consume_result_bucket=\(senderDebugPendingMetadataFileHandoffConsumeResultBucket)",
            ...
            "app_claim_request_started=\(appClaimRequestStarted)",
            "app_claim_request_url_bucket=\(appClaimRequestURLBucket)",
            "app_claim_auth_header_present=\(senderMetadataClaimAuthHeaderAttached)",
            "app_claim_auth_scheme_bucket=\(appClaimAuthSchemeBucket)",
            "app_claim_auth_token_bucket=\(appClaimAuthTokenBucket)",
            "app_claim_auth_source_bucket=\(appClaimAuthSourceBucket)",
            "app_claim_http_status_bucket=\(appClaimHTTPStatusBucket)",
            "server_claim_auth_header_seen=\(serverClaimAuthHeaderSeen)",
            "server_claim_auth_scheme_bucket=\(serverClaimAuthSchemeBucket)",
            "server_claim_token_validation_bucket=\(serverClaimTokenValidationBucket)",
            "server_claim_authenticated_user_bucket=\(serverClaimAuthenticatedUserBucket)",
            ...
            "sender_local_audio_publish_requested=\(senderLocalAudioPublishRequested)",
            ...
            "sender_remote_audio_track_seen_proof_path_available=\(senderRemoteAudioTrackSeenProofPathAvailable)",
    ...
    mutating func markDebugPendingMetadataFileHandoffSeen(shapeBucket: String) {
        senderDebugPendingMetadataFileHandoffSeen = true
        senderDebugPendingMetadataFileHandoffShapeBucket = shapeBucket
        senderPendingMetadataHandoffResultBucket = "file_handoff_seen_redacted"
    }

    mutating func markDebugPendingMetadataFileHandoffConsumed(resultBucket: String) {
        senderDebugPendingMetadataFileHandoffConsumed = resultBucket == "deleted_redacted"
        senderDebugPendingMetadataFileHandoffConsumeResultBucket = resultBucket
    ...
    mutating func markServerSideSenderMetadataClaimStarted() {
        ...
        appClaimRequestStarted = false
        appClaimRequestURLBucket = "missing"
        appClaimAuthSchemeBucket = "missing"
        appClaimAuthTokenBucket = "missing"
        appClaimAuthSourceBucket = "missing"
        appClaimHTTPStatusBucket = "not_requested"
        serverClaimAuthHeaderSeen = false
        serverClaimAuthSchemeBucket = "missing"
        serverClaimTokenValidationBucket = "not_reached"
        serverClaimAuthenticatedUserBucket = "not_reached"
    ...
    mutating func markServerSideSenderMetadataClaimAuthContext(activeSessionAvailable: Bool,
                                                               ...
                                                               requestStarted: Bool = false,
                                                               requestURLBucket: String = "missing",
                                                               appHTTPStatusBucket: String = "not_requested",
                                                               serverAuthHeaderSeen: Bool = false,
                                                               serverAuthSchemeBucket: String = "missing",
                                                               serverTokenValidationBucket: String = "not_reached",
                                                               serverAuthenticatedUserBucket: String = "not_reached") {
        ...
        appClaimRequestStarted = requestStarted
        appClaimRequestURLBucket = requestURLBucket
        appClaimAuthSchemeBucket = authHeaderAttached ? "bearer_redacted" : "missing"
        appClaimAuthTokenBucket = accessTokenAvailable ? "present_redacted" : "missing"
        appClaimAuthSourceBucket = authSourceBucket
        appClaimHTTPStatusBucket = appHTTPStatusBucket
        serverClaimAuthHeaderSeen = serverAuthHeaderSeen
        serverClaimAuthSchemeBucket = serverAuthSchemeBucket
        serverClaimTokenValidationBucket = serverTokenValidationBucket
        serverClaimAuthenticatedUserBucket = serverAuthenticatedUserBucket
    ...
    mutating func markReferenceHandoff(_ handoff: SalemXSenderPendingMetadataReferenceHandoff, armGenerationChanged: Bool = false) {
        ...
        if handoff.referencePresent {
            senderPendingMetadataHandoffResultBucket = "memory_reference_present_redacted"
        }
    }
    ...
    mutating func markNoMediaRuntimeJoin(_ result: Result<Void, DirectCallMediaError>) {
        ...
        case .success:
            ...
            senderLiveKitRoomConnectedLatchBucket = "available_redacted"
    ...
    mutating func markSenderRemoteAudioProofStarted() {
        senderRemoteAudioObserverPathAvailable = true
        senderRemoteAudioTrackSeenProofPathAvailable = true
...
private struct SalemXVoIPPushReceiptProofSummary {
    ...
    var receiverRuntimeAudioTriggerPayloadGateBucket = "missing_redacted"
    var receiverAudioPublishConsumeGateSourceBucket = "missing_redacted"
    var receiverAudioPublishConsumeGateBucket = "missing_redacted"
    var receiverAudioPublishInvokeGateBucket = "missing_redacted"
    ...
    var receiverLocalAudioTrackCreateAttempted = false
    var receiverLocalAudioTrackCreateBlockedReasonBucket = "unknown_redacted"
    var receiverLocalAudioTrackPublishResultBucket = "not_requested"
    ...
    var receiverRemoteAudioObserverBoundToRetainedRoom = false
    var receiverRemoteAudioObserverBoundToConnectedRoom = false
    var receiverRemoteAudioObserverAttachedAfterParticipantSeen = false
    var receiverRemoteAudioSubscriptionRepairPresent = true
    ...
    var receiverRemoteAudioSubscriptionWaitStarted = false
    var receiverRemoteAudioSubscriptionWaitCompleted = false
    var receiverRemoteAudioSubscriptionWaitTimeout = false
    var receiverRemoteAudioSubscriptionFinalClassification = "not_started"
    var receiverRemoteAudioLevelObserved = false
    var receiverRemoteAudioLivenessObserved = false
    var receiverRemoteAudioLivenessWaitStarted = false
    var receiverRemoteAudioLivenessWaitCompleted = false
    var receiverRemoteAudioLivenessWaitTimeout = false
    var receiverRemoteAudioLivenessFinalClassification = "not_started"
    var senderLocalAudioPublishRequested = false
    var senderLocalAudioPublishAllowed = false
    var senderLocalAudioPublishResult = "not_requested"
    var senderLocalAudioMutedStateBucket = "unknown"
    ...
    var redactedLines: [String] {
        [
            ...
            "receiver_runtime_audio_trigger_payload_gate_bucket=\(receiverRuntimeAudioTriggerPayloadGateBucket)",
            "receiver_audio_publish_consume_gate_source_bucket=\(receiverAudioPublishConsumeGateSourceBucket)",
            "receiver_audio_publish_consume_gate_bucket=\(receiverAudioPublishConsumeGateBucket)",
            "receiver_audio_publish_invoke_gate_bucket=\(receiverAudioPublishInvokeGateBucket)",
            ...
            "receiver_local_audio_track_create_attempted=\(receiverLocalAudioTrackCreateAttempted)",
            "receiver_local_audio_track_create_blocked_reason_bucket=\(receiverLocalAudioTrackCreateBlockedReasonBucket)",
            "receiver_local_audio_track_publish_result_bucket=\(receiverLocalAudioTrackPublishResultBucket)",
            ...
            "receiver_remote_audio_observer_bound_to_retained_room=\(receiverRemoteAudioObserverBoundToRetainedRoom)",
            "receiver_remote_audio_observer_bound_to_connected_room=\(receiverRemoteAudioObserverBoundToConnectedRoom)",
            "receiver_remote_audio_observer_attached_after_participant_seen=\(receiverRemoteAudioObserverAttachedAfterParticipantSeen)",
            "receiver_remote_audio_subscription_repair_present=\(receiverRemoteAudioSubscriptionRepairPresent)",
            ...
            "receiver_remote_audio_subscription_wait_started=\(receiverRemoteAudioSubscriptionWaitStarted)",
            "receiver_remote_audio_subscription_wait_completed=\(receiverRemoteAudioSubscriptionWaitCompleted)",
            "receiver_remote_audio_subscription_wait_timeout=\(receiverRemoteAudioSubscriptionWaitTimeout)",
            "receiver_remote_audio_subscription_final_classification=\(receiverRemoteAudioSubscriptionFinalClassification)",
            "receiver_remote_audio_level_observed=\(receiverRemoteAudioLevelObserved)",
            "receiver_remote_audio_liveness_observed=\(receiverRemoteAudioLivenessObserved)",
            "receiver_remote_audio_liveness_wait_started=\(receiverRemoteAudioLivenessWaitStarted)",
            "receiver_remote_audio_liveness_wait_completed=\(receiverRemoteAudioLivenessWaitCompleted)",
            "receiver_remote_audio_liveness_wait_timeout=\(receiverRemoteAudioLivenessWaitTimeout)",
            "receiver_remote_audio_liveness_final_classification=\(receiverRemoteAudioLivenessFinalClassification)",
            "sender_local_audio_publish_requested=\(senderLocalAudioPublishRequested)",
            "sender_local_audio_publish_allowed=\(senderLocalAudioPublishAllowed)",
            "sender_local_audio_publish_result=\(senderLocalAudioPublishResult)",
            "sender_local_audio_muted_state_bucket=\(senderLocalAudioMutedStateBucket)",
...
private extension SalemXVoIPPushReceiptProofSummary {
    ...
    mutating func refreshRemoteAudioLivenessDiagnostics() {
        refreshRemoteAudioLivenessProofSurface()
        ...
        if liveKitJoinRequested {
            ...
            receiverLiveKitJoinStateLatchBucket = liveKitRoomConnected && receiverConnectedSessionLeaseRoomRetained && !receiverConnectedSessionLeaseReleased ? "available_redacted" : "missing_redacted"
            ...
            receiverLiveKitJoinStateLatchBucket = receiverConnectedSessionLeaseRoomRetained && !receiverConnectedSessionLeaseReleased ? "available_redacted" : "missing_redacted"
        ...
        receiverRemoteAudioTrackSubscribed = receiverRemoteAudioTrackSubscribed || liveKitRemoteAudioTrackSubscribed
        receiverRemoteAudioTrackUnmuted = receiverRemoteAudioTrackUnmuted || liveKitRemoteAudioTrackUnmuted
        receiverRemoteAudioLevelObserved = receiverRemoteAudioLevelObserved || liveKitRemoteAudioLevelObserved
        receiverRemoteAudioLivenessObserved = receiverRemoteAudioLivenessObserved || liveKitAudioLivenessObserved
        receiverRemoteAudioLivenessWaitStarted = receiverRemoteAudioLivenessWaitStarted ||
            (liveKitJoinResult == "success_redacted" && liveKitRemoteParticipantSeen)
        receiverRemoteAudioLivenessWaitCompleted = receiverRemoteAudioLivenessWaitCompleted || receiverRemoteAudioLivenessObserved
        receiverRemoteAudioLivenessWaitTimeout = receiverRemoteAudioLivenessWaitStarted &&
            !receiverRemoteAudioLivenessObserved &&
            (remoteParticipantObservationWaitCompleted || receiverParticipantObservationAfterOverlapTimeout)
        refreshReceiverRemoteAudioSubscriptionClassification()
        videoEnabled = controlledConnectFirstAttemptVideoAllowed || senderSideLiveKitJoinHookVideoAllowed
    ...
    private mutating func refreshRemoteAudioLivenessProofSurface() {
    ...
    private var receiverAudioPublishTerminal: Bool {
        localAudioPublishRequested &&
            (localAudioPublishResult == "success_redacted" || localAudioPublishResult == "failed_redacted")
    }

    var shouldDeferReceiverConnectedSessionLeaseReleaseForAudioTerminal: Bool {
        let receiverAudioPublishPending = receiverAudioPublishTriggerSeenByApp &&
    ...
    mutating func refreshReceiverRemoteAudioSubscriptionClassification() {
        ...
        receiverRemoteAudioSubscriptionWaitCompleted = receiverRemoteAudioSubscriptionWaitCompleted ||
            receiverRemoteAudioTrackSubscribed
        receiverRemoteAudioSubscriptionWaitTimeout = receiverRemoteAudioSubscriptionWaitStarted &&
            !receiverRemoteAudioTrackSubscribed &&
            (remoteParticipantObservationWaitCompleted || receiverParticipantObservationAfterOverlapTimeout)
    ...
    mutating func refreshRemoteAudioTrackLivenessClassification() {
        refreshReceiverRemoteAudioSubscriptionClassification()
        if receiverRemoteAudioLivenessObserved || liveKitAudioLivenessObserved {
            receiverRemoteAudioLivenessFinalClassification = "remote_audio_liveness_observed_redacted"
            receiverRemoteAudioLivenessWaitCompleted = true
            receiverRemoteAudioLivenessWaitTimeout = false
            liveKitAudioLivenessResult = "success_redacted"
            liveKitAudioLivenessErrorBucket = "none"
            return
        }

        if senderLocalAudioPublishRequested, senderLocalAudioPublishResult != "success_redacted" {
            receiverRemoteAudioLivenessFinalClassification = senderMicrophonePermissionRequested && senderMicrophonePermissionResultBucket != "success_redacted" ?
                "sender_microphone_permission_blocked_redacted" : "sender_audio_publish_not_requested_redacted"
            liveKitAudioLivenessErrorBucket = receiverRemoteAudioLivenessFinalClassification
            return
        }

        if senderLocalAudioPublishResult == "success_redacted",
           !senderAudioSessionActivationObserved {
            receiverRemoteAudioLivenessFinalClassification = "sender_audio_session_not_active_redacted"
            liveKitAudioLivenessErrorBucket = receiverRemoteAudioLivenessFinalClassification
            return
        }
        ...
        if !receiverRemoteAudioPublicationSeen {
            ...
            receiverRemoteAudioLivenessFinalClassification =
                receiverRemoteAudioSubscriptionFinalClassification == "pending_redacted" ?
                "remote_audio_subscription_missing_redacted" :
                receiverRemoteAudioSubscriptionFinalClassification
            liveKitAudioLivenessErrorBucket = receiverRemoteAudioLivenessFinalClassification
        } else if !receiverRemoteAudioTrackUnmuted {
            receiverRemoteAudioLivenessFinalClassification = "remote_audio_track_muted_redacted"
            liveKitAudioLivenessErrorBucket = "remote_audio_track_muted_redacted"
        } else if receiverRemoteAudioLivenessWaitTimeout {
            receiverRemoteAudioLivenessFinalClassification = "remote_audio_track_subscribed_but_silent_redacted"
            liveKitAudioLivenessErrorBucket = "remote_audio_track_subscribed_but_silent_redacted"
        } else if receiverRemoteAudioLivenessWaitStarted {
            receiverRemoteAudioLivenessFinalClassification = "remote_audio_liveness_timeout_redacted"
            liveKitAudioLivenessErrorBucket = "remote_audio_liveness_timeout_redacted"
        } else {
            receiverRemoteAudioLivenessFinalClassification = "not_started"
        }
    }
    ...
    mutating func recordSenderRuntimeLocalAudioPublish(_ senderSummary: SalemXSenderRuntimeLiveKitJoinProofSummary) {
        senderLocalAudioPublishRequested = senderSummary.senderLocalAudioPublishRequested
    ...
    mutating func recordReceiverRemoteAudioSubscriptionCallback() {
        receiverRemoteAudioSubscriptionRepairPresent = true
        receiverRemoteAudioSubscriptionRepairDebugOnly = true
        receiverRemoteAudioSubscriptionRawIdentifiersLogged = false
        receiverRemoteAudioSubscriptionCallbackSeen = true
        receiverRemoteAudioSubscriptionWaitStarted = true
        receiverRemoteAudioSubscriptionWaitCompleted = true
        receiverRemoteAudioSubscriptionWaitTimeout = false
        receiverRemoteAudioExplicitSubscribeConfirmed = true
    ...
    mutating func recordReceiverAudioPublishGateInspection(armed: Bool = false) {
        ...
        recordReceiverAudioPublishConsumeGateAlignment(armed: armed)
        if armed {
        ...
        senderRemoteAudioObserverPathAvailable = true
        senderSubscribeRemoteAudioPathAvailable = true
        refreshRemoteAudioLivenessDiagnostics()
    }

    mutating func recordReceiverAudioPublishTriggerPayloadGate(present: Bool) {
        receiverRuntimeAudioTriggerPayloadGateBucket = present ? "present_redacted" : "missing_redacted"
        if present {
            recordReceiverAudioPublishGateInspection(armed: true)
        }
    }

    mutating func recordReceiverAudioPublishConsumeGateAlignment(armed: Bool) {
        receiverAudioPublishConsumeGateSourceBucket = armed ? "latched_runtime_gate_redacted" : "missing_redacted"
        receiverAudioPublishConsumeGateBucket = armed ? "enabled_redacted" : "missing_redacted"
        receiverAudioPublishInvokeGateBucket = armed ? "enabled_redacted" : "missing_redacted"
    }
    ...
    mutating func recordReceiverAudioPublishTriggerStarted(confirmed: Bool,
        ...
        } else if receiverRuntimeAudioTriggerPayloadGateBucket != "present_redacted" {
            receiverAudioPublishBlockedReasonBucket = "missing_trigger_gate_payload_redacted"
            blockedReason = "receiver_audio_publish_missing_trigger_gate_payload_redacted"
        } else if !ready {
            receiverAudioPublishBlockedReasonBucket = leaseAvailable ? "missing_audio_gate_redacted" : "missing_livekit_room_latch_redacted"
            blockedReason = "receiver_audio_publish_not_ready_redacted"
        } else {
            receiverAudioPublishBlockedReasonBucket = "none"
            blockedReason = "receiver_audio_publish_pending_redacted"
        }
    }
    ...
    mutating func recordReceiverAudioPublishFunctionEntered(ready: Bool) {
        ...
        if ready {
            receiverAudioPublishBlockedReasonBucket = "none"
            blockedReason = "receiver_audio_publish_permission_decision_redacted"
        }
    }
    ...
    mutating func recordReceiverAudioPublishRequestDispatched() {
        ...
        localAudioPublishRequested = true
        localAudioPublishStarted = true
    ...
    mutating func recordRemoteAudioLivenessObservation(participantSeen: Bool,
        ...
        liveKitAudioLivenessObserved = liveKitAudioLivenessObserved || livenessObserved
        receiverRemoteAudioTrackSubscribed = receiverRemoteAudioTrackSubscribed || liveKitRemoteAudioTrackSubscribed
        receiverRemoteAudioTrackUnmuted = receiverRemoteAudioTrackUnmuted || liveKitRemoteAudioTrackUnmuted
        receiverRemoteAudioLevelObserved = receiverRemoteAudioLevelObserved || liveKitRemoteAudioLevelObserved
        receiverRemoteAudioLivenessObserved = receiverRemoteAudioLivenessObserved || liveKitAudioLivenessObserved
        receiverRemoteAudioObserverBoundToRetainedRoom = receiverRemoteAudioObserverBoundToRetainedRoom ||
            receiverParticipantObserverBoundToRetainedRoom ||
            receiverConnectedSessionLeaseRoomRetained
        receiverRemoteAudioObserverBoundToConnectedRoom = receiverRemoteAudioObserverBoundToConnectedRoom ||
        ...
        receiverRemoteAudioLivenessWaitCompleted = receiverRemoteAudioLivenessWaitCompleted || livenessObserved
        receiverRemoteAudioSubscriptionWaitStarted = receiverRemoteAudioSubscriptionWaitStarted ||
            audioPublicationSeen ||
            receiverRemoteAudioExplicitSubscribeRequested
        receiverRemoteAudioSubscriptionWaitCompleted = receiverRemoteAudioSubscriptionWaitCompleted || audioTrackSubscribed
        receiverRemoteAudioSubscriptionWaitTimeout = receiverRemoteAudioSubscriptionWaitStarted &&
            !receiverRemoteAudioTrackSubscribed &&
            (remoteParticipantObservationWaitCompleted || receiverParticipantObservationAfterOverlapTimeout)
        liveKitAudioLivenessResult = liveKitAudioLivenessObserved ? "success_redacted" : "not_observed_redacted"
        if liveKitAudioLivenessObserved {
            liveKitAudioLivenessErrorBucket = "none"
    ...
    private var shouldCompleteRemoteParticipantObservationAfterRemoteAudioUpdate: Bool {
        ...
        if receiverRemoteAudioLivenessWaitTimeout || receiverRemoteAudioSubscriptionWaitTimeout {
            return true
        }
        return !receiverRemoteAudioSubscriptionWaitStarted
    }
    ...
    mutating func recordReceiverParticipantSnapshotObservation(_ snapshot: DirectCallRemoteParticipantSnapshot) {
        ...
        if snapshot.participantSeen, snapshot.identityFilterResult != "filtered_out_redacted" {
            recordRemoteAudioLivenessObservation(participantSeen: true,
                                                 participantCountBucket: receiverParticipantSnapshotCountBucket,
                                                 audioPublicationSeen: snapshot.audioPublicationSeen,
    ...
    private mutating func recordRemoteParticipantPresenceObservation(participantCountBucket: String, classification: String) {
        ...
        if shouldCompleteRemoteParticipantObservationAfterRemoteAudioUpdate {
    ...
    mutating func completeRemoteParticipantObservationTimeout(timeoutBucket: String) {
        ...
        if receiverRemoteAudioSubscriptionWaitStarted, !receiverRemoteAudioTrackSubscribed {
            receiverRemoteAudioSubscriptionWaitTimeout = true
        }
        if receiverRemoteAudioLivenessWaitStarted, !receiverRemoteAudioLivenessObserved {
            receiverRemoteAudioLivenessWaitTimeout = true
        }
        refreshReceiverRemoteAudioSubscriptionClassification()
        refreshRemoteAudioTrackLivenessClassification()
    ...
    private func remoteParticipantObservationPreconditionTimeoutClassification() -> String? {
        if liveKitRemoteParticipantSeen,
           let classification = remoteAudioObservationTimeoutClassification() {
            return classification
        }
        if liveKitRemoteParticipantSeen {
...
final class SalemXPushKitRegistrationSmokeDebugBridge: NSObject {
    ...
    private static let senderRemoteAudioProofURLHookPath = "/direct-call/sender-remote-audio-proof"
    ...
    private static let receiverAudioPublishTriggerURLHookPath = "/direct-call/receiver-audio-publish-trigger"
    private static let receiverAudioPublishTriggerGateMarker = "receiver_audio_publish_controlled_gate"
    ...
    private static let receiverAudioPublishTriggerConfirmation = "RUN_2_49Z6X_RECEIVER_AUDIO_PUBLISH"
    ...
    private static func handleReceiverDebugURLHook(_ url: URL, normalizedPath: String) -> Bool {
        if handleReceiverSmokeURLHook(url, normalizedPath: normalizedPath) {
            return true
        }

        return handleReceiverDirectCallURLHook(url, normalizedPath: normalizedPath)
    }

    private static func handleReceiverSmokeURLHook(_ url: URL, normalizedPath: String) -> Bool {
    ...
    private static func handleReceiverDirectCallURLHook(_ url: URL, normalizedPath: String) -> Bool {
        ...
        if normalizedPath == receiverAudioPublishTriggerURLHookPath {
            let components = URLComponents(url: url, resolvingAgainstBaseURL: false)
            startReceiverAudioPublishTriggerURLHook(components)
            return true
        }
    ...
    private static func handleSenderRuntimeURLHook(_ url: URL, normalizedPath: String) -> Bool {
        ...
        if normalizedPath == senderLiveKitReadinessURLHookPath {
            ...
            return true
        } else if normalizedPath == senderRemoteAudioProofURLHookPath {
            startSenderRemoteAudioProofURLHook()
            return true
    ...
    private static func startReceiverAudioPublishTriggerURLHook(_ components: URLComponents?) {
        let confirmed = components?.queryItems?.first { $0.name == "confirm" }?.value == receiverAudioPublishTriggerConfirmation
        let payloadGatePresent = receiverAudioPublishTriggerPayloadGatePresent(components)
        lock.lock()
        var summary = latestVoIPPushReceiptSummary
        receiverAudioPublishGateArmed = receiverAudioPublishGateArmed || payloadGatePresent
        if confirmed, payloadGatePresent {
        ...
        summary.recordReceiverAudioPublishTriggerPayloadGate(present: payloadGatePresent)
        summary.recordReceiverAudioPublishGateInspection(armed: receiverAudioPublishGateArmed)
        if !confirmed {
            summary.recordReceiverAudioPublishTriggerStarted(confirmed: false,
                                                             ready: false,
    ...
    private static func runReceiverAudioPublishTriggerIfAllowed() async {
        ...
        let triggerPayloadGatePresent = receiverAudioPublishPendingTriggerLatched ||
            summary.receiverRuntimeAudioTriggerPayloadGateBucket == "present_redacted" ||
            summary.receiverAudioPublishGateLatchedWithPendingTriggerBucket == "present_redacted"
        ...
        let result = await lease.client.setMicrophoneEnabled(true)
        lock.lock()
        summary = latestVoIPPushReceiptSummary
    ...
    private static func armSenderPendingMetadataReferenceHandoff(reference: String?,
                                                                 source: String) {
    ...
    private static func startSenderRemoteAudioProofURLHook() {
        lock.lock()
        var summary = latestSenderRuntimeLiveKitJoinSummary
        summary.markSenderRemoteAudioProofStarted()
        lock.unlock()

        updateLatestSenderRuntimeLiveKitJoinSummary(summary)

        Task { @MainActor in
            await runSenderRemoteAudioProof()
        }
    }
    ...
    @MainActor
    private static func runSenderRemoteAudioProof() async {
        guard let client = senderRuntimeLiveKitClient else {
            lock.lock()
            var summary = latestSenderRuntimeLiveKitJoinSummary
            summary.markSenderRemoteAudioProofStarted()
            summary.senderLiveKitRoomConnectedLatchBucket = "missing_redacted"
            lock.unlock()
            updateLatestSenderRuntimeLiveKitJoinSummary(summary)
            return
        }
        ...
        lock.lock()
        var summary = latestSenderRuntimeLiveKitJoinSummary
        summary.markSenderRemoteAudioProof(remotePlaybackResult: remotePlaybackResult,
                                           snapshot: snapshot)
        lock.unlock()
    ...
    private static func fetchServerSideSenderMetadataClaim() async -> DirectCallSession? {
        ...
        recordServerSideSenderMetadataClaimAuthContext(sessionAvailability,
                                                       ...
                                                       requestURLBucket: "expected_route_redacted")
        guard let accessToken = await SalemXForegroundSSESmokeDebug.matrixAccessTokenForPushKitUploadSmoke() else {
        ...
        let request = senderMetadataClaimRequest(url: fetchURL, accessToken: accessToken)
        ...
        do {
            ...
            guard let httpResponse = response as? HTTPURLResponse,
                  (200..<300).contains(httpResponse.statusCode) else {
                let diagnostics = pendingMetadataFetchFailureDiagnostics(response: response, data: data)
                recordServerSideSenderMetadataClaimAuthFailureContext(sessionAvailability, diagnostics: diagnostics)
                if let retrySession = try await retryServerSideSenderMetadataClaim(fetchURL: fetchURL,
            ...
            recordServerSideSenderMetadataClaimAuthSuccessContext(sessionAvailability)
            guard let session = directCallSessionFromSenderPendingMetadata(data: data) else {
            ...
            recordServerSideSenderMetadataClaimAuthContext(sessionAvailability,
                                                           ...
                                                           requestStarted: true,
                                                           requestURLBucket: "expected_route_redacted",
                                                           appHTTPStatusBucket: "failed_redacted",
                                                           serverAuthHeaderSeen: false,
                                                           serverAuthSchemeBucket: "missing",
                                                           serverTokenValidationBucket: "not_reached",
                                                           serverAuthenticatedUserBucket: "not_reached")
            recordServerSideSenderMetadataClaimBlocked(resultBucket: "blocked_redacted",
    ...
    private static func senderMetadataClaimRequest(url: URL, accessToken: String) -> URLRequest {
    ...
    @MainActor
    private static func retryServerSideSenderMetadataClaim(fetchURL: URL,
                                                           sessionAvailability: MatrixSessionWhoamiSmokeAvailability,
                                                           diagnostics: PendingMetadataFetchFailureDiagnostics) async throws -> DirectCallSession? {
        guard diagnostics.failureReason == "auth_rejected",
              let retryAccessToken = await SalemXForegroundSSESmokeDebug.matrixAccessTokenForPushKitUploadSmoke(),
              !retryAccessToken.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty else {
            return nil
        }

        let retryRequest = senderMetadataClaimRequest(url: fetchURL, accessToken: retryAccessToken)
        let (retryData, retryResponse) = try await URLSession.shared.data(for: retryRequest)
        if let retryHTTPResponse = retryResponse as? HTTPURLResponse,
           (200..<300).contains(retryHTTPResponse.statusCode),
           let retrySession = directCallSessionFromSenderPendingMetadata(data: retryData) {
            recordServerSideSenderMetadataClaimAuthSuccessContext(sessionAvailability)
            recordServerSideSenderMetadataClaimSuccess(retrySession)
            return retrySession
        }

        let retryDiagnostics = pendingMetadataFetchFailureDiagnostics(response: retryResponse, data: retryData)
        recordServerSideSenderMetadataClaimAuthFailureContext(sessionAvailability, diagnostics: retryDiagnostics)
        recordServerSideSenderMetadataClaimBlocked(resultBucket: serverSideSenderMetadataClaimResultBucket(retryDiagnostics),
                                                   reason: serverSideSenderMetadataClaimBlockedReason(retryDiagnostics),
                                                   authorized: true,
                                                   diagnostics: retryDiagnostics)
        return nil
    }

    private static func recordServerSideSenderMetadataClaimAuthSuccessContext(_ availability: MatrixSessionWhoamiSmokeAvailability) {
        recordServerSideSenderMetadataClaimAuthContext(availability,
                                                       accessTokenAvailable: true,
                                                       authHeaderAttached: true,
                                                       authSourceBucket: "current_session_redacted",
                                                       ...
                                                       requestStarted: true,
                                                       requestURLBucket: "expected_route_redacted",
                                                       appHTTPStatusBucket: "2xx_redacted",
                                                       serverAuthHeaderSeen: true,
                                                       serverAuthSchemeBucket: "bearer_redacted",
                                                       serverTokenValidationBucket: "success_redacted",
                                                       serverAuthenticatedUserBucket: "present_redacted")
    }

    private static func recordServerSideSenderMetadataClaimAuthFailureContext(_ availability: MatrixSessionWhoamiSmokeAvailability,
                                                                              diagnostics: PendingMetadataFetchFailureDiagnostics) {
        recordServerSideSenderMetadataClaimAuthContext(availability,
                                                       accessTokenAvailable: true,
                                                       authHeaderAttached: true,
                                                       authSourceBucket: "current_session_redacted",
                                                       ...
                                                       requestStarted: true,
                                                       requestURLBucket: "expected_route_redacted",
                                                       appHTTPStatusBucket: appClaimHTTPStatusBucket(diagnostics.httpStatusBucket),
                                                       serverAuthHeaderSeen: diagnostics.serverAuthHeaderSeen,
                                                       serverAuthSchemeBucket: diagnostics.serverAuthSchemeBucket,
                                                       serverTokenValidationBucket: diagnostics.serverTokenValidationBucket,
                                                       serverAuthenticatedUserBucket: diagnostics.serverAuthenticatedUserBucket)
    }
    ...
    private static func recordServerSideSenderMetadataClaimAuthContext(_ availability: MatrixSessionWhoamiSmokeAvailability,
        ...
        summary.markServerSideSenderMetadataClaimAuthContext(activeSessionAvailable: availability.activeSessionAvailable,
                                                             ...
                                                             requestURLBucket: requestURLBucket,
                                                             appHTTPStatusBucket: appHTTPStatusBucket,
                                                             serverAuthHeaderSeen: serverAuthHeaderSeen,
                                                             serverAuthSchemeBucket: serverAuthSchemeBucket,
                                                             serverTokenValidationBucket: serverTokenValidationBucket,
                                                             serverAuthenticatedUserBucket: serverAuthenticatedUserBucket)
        lock.unlock()
    ...
    private static func serverSideSenderMetadataClaimAuthValidationBucket(_ diagnostics: PendingMetadataFetchFailureDiagnostics) -> String {
        if diagnostics.serverTokenValidationBucket != "not_reached" {
            return diagnostics.serverTokenValidationBucket
        }
        switch diagnostics.failureReason {
        case "auth_rejected":
            return "unauthorized_redacted"
    ...
    private static func serverSideSenderMetadataClaimBoundSenderBucket(_ diagnostics: PendingMetadataFetchFailureDiagnostics) -> String {
        if diagnostics.serverBoundSenderBucket != "not_checked" {
            return diagnostics.serverBoundSenderBucket
        }
        switch diagnostics.failureReason {
        case "forbidden":
    ...
    private static func serverSideSenderMetadataClaimBoundDeviceBucket(_ diagnostics: PendingMetadataFetchFailureDiagnostics) -> String {
        if diagnostics.serverBoundDeviceBucket != "not_checked" {
            return diagnostics.serverBoundDeviceBucket
        }
        switch diagnostics.failureReason {
        case "forbidden":
            return "mismatch_redacted"
    ...
    private static func appClaimHTTPStatusBucket(_ httpStatusBucket: String) -> String {
        switch httpStatusBucket {
        case "2xx":
            return "2xx_redacted"
        case "401":
            return "401_redacted"
    ...
    private static func startSenderPendingMetadataReferenceHandoffFilePolling() {
        senderPendingMetadataReferenceHandoffFilePollTask?.cancel()
        senderPendingMetadataReferenceHandoffFilePollTask = Task {
            for _ in 0..<240 {
                if Task.isCancelled {
                    return
                }
                if consumeSenderPendingMetadataReferenceHandoffFileIfNeeded() {
                    return
                }
                try? await Task.sleep(nanoseconds: 500_000_000)
            }
    ...
    private static func consumeSenderPendingMetadataReferenceHandoffFileIfNeeded() -> Bool {
        guard let handoffURL = senderPendingMetadataReferenceHandoffFileURL(),
              FileManager.default.fileExists(atPath: handoffURL.path) else {
            return false
        }

        let diagnostics = senderPendingMetadataReferenceHandoffFileDiagnostics(handoffURL)
        recordSenderDebugPendingMetadataFileHandoffSeen(shapeBucket: diagnostics.shapeBucket)

        guard diagnostics.validShape, let reference = diagnostics.reference else {
            recordSenderDebugPendingMetadataFileHandoffConsumed(resultBucket: "invalid_shape_redacted")
            return true
        }

        do {
            try FileManager.default.removeItem(at: handoffURL)
            recordSenderDebugPendingMetadataFileHandoffConsumed(resultBucket: "deleted_redacted")
            armSenderPendingMetadataReferenceHandoff(reference: reference,
                                                     source: "file_handoff_redacted")
        } catch {
            recordSenderDebugPendingMetadataFileHandoffConsumed(resultBucket: "delete_failed_redacted")
        }
        return true
    }

    private struct SenderPendingMetadataReferenceHandoffFileDiagnostics {
        let validShape: Bool
        let shapeBucket: String
        let reference: String?
    }

    private static func senderPendingMetadataReferenceHandoffFileDiagnostics(_ handoffURL: URL) -> SenderPendingMetadataReferenceHandoffFileDiagnostics {
        ...
        let validShape = triggerKind == "sender_pending_metadata_reference_handoff" && markerVersion == "2.49W" && referenceAllowed && !reference.isEmpty
        return .init(validShape: validShape,
                     shapeBucket: validShape ? "valid_sender_pending_metadata_handoff_redacted" : "invalid_shape_redacted",
                     reference: validShape ? reference : nil)
    }

    private static func senderPendingMetadataReferenceHandoffFileURL() -> URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appending(component: senderPendingMetadataReferenceHandoffFileName)
    }
    ...
    private static func recordSenderDebugPendingMetadataFileHandoffSeen(shapeBucket: String) {
        lock.lock()
        var summary = latestSenderRuntimeLiveKitJoinSummary
        summary.markDebugPendingMetadataFileHandoffSeen(shapeBucket: shapeBucket)
        lock.unlock()

        updateLatestSenderRuntimeLiveKitJoinSummary(summary)
    }

    private static func recordSenderDebugPendingMetadataFileHandoffConsumed(resultBucket: String) {
        lock.lock()
        var summary = latestSenderRuntimeLiveKitJoinSummary
    ...
    private static func propagateSenderRuntimeJoinTerminalToReceiverObservation(_ senderSummary: SalemXSenderRuntimeLiveKitJoinProofSummary) {
        ...
        summary.recordSenderRuntimeLocalAudioPublish(senderSummary)
    ...
    private static func senderRuntimeTerminalProofLines(from proof: String) -> String {
        ...
        return [
            ...
            "carpediem_matrix_session_present=\(senderRuntimeBoolField("carpediem_matrix_session_present", in: fields))",
            "carpediem_matrix_session_user_bucket=\(senderRuntimeField("carpediem_matrix_session_user_bucket", in: fields))",
            "carpediem_access_token_available_bucket=\(senderRuntimeField("carpediem_access_token_available_bucket", in: fields))",
            "sender_metadata_claim_auth_header_attached=\(senderRuntimeBoolField("sender_metadata_claim_auth_header_attached", in: fields))",
            "sender_metadata_claim_auth_source_bucket=\(senderRuntimeField("sender_metadata_claim_auth_source_bucket", in: fields))",
            "app_claim_request_started=\(senderRuntimeBoolField("app_claim_request_started", in: fields))",
            "app_claim_request_url_bucket=\(senderRuntimeField("app_claim_request_url_bucket", in: fields))",
            "app_claim_auth_header_present=\(senderRuntimeBoolField("app_claim_auth_header_present", in: fields))",
            "app_claim_auth_scheme_bucket=\(senderRuntimeField("app_claim_auth_scheme_bucket", in: fields))",
            "app_claim_auth_token_bucket=\(senderRuntimeField("app_claim_auth_token_bucket", in: fields))",
            "app_claim_auth_source_bucket=\(senderRuntimeField("app_claim_auth_source_bucket", in: fields))",
            "app_claim_http_status_bucket=\(senderRuntimeField("app_claim_http_status_bucket", in: fields))",
            "server_claim_auth_header_seen=\(senderRuntimeBoolField("server_claim_auth_header_seen", in: fields))",
            "server_claim_auth_scheme_bucket=\(senderRuntimeField("server_claim_auth_scheme_bucket", in: fields))",
            "server_claim_token_validation_bucket=\(senderRuntimeField("server_claim_token_validation_bucket", in: fields))",
            "server_claim_authenticated_user_bucket=\(senderRuntimeField("server_claim_authenticated_user_bucket", in: fields))",
...
extension SalemXPushKitRegistrationSmokeDebugBridge {
    ...
    private struct PendingMetadataFetchFailureDiagnostics {
        ...
        let serverAuthHeaderSeen: Bool
        let serverAuthSchemeBucket: String
        let serverTokenValidationBucket: String
        let serverAuthenticatedUserBucket: String
        let serverBoundSenderBucket: String
        let serverBoundDeviceBucket: String
    }
    ...
    private static func pendingMetadataFetchFailureDiagnostics(response: URLResponse?,
        ...
        guard let httpResponse = response as? HTTPURLResponse else {
            return .init(httpStatusBucket: "unknown",
                         ...
                         serverTokenValidationBucket: "not_reached",
                         serverAuthenticatedUserBucket: "not_reached",
                         serverBoundSenderBucket: "not_checked",
                         serverBoundDeviceBucket: "not_checked")
        }
        ...
        return .init(httpStatusBucket: pendingMetadataFetchHTTPStatusBucket(httpResponse.statusCode),
                     ...
                     serverAuthHeaderSeen: pendingMetadataFetchDiagnosticBool(data: data, key: "server_claim_auth_header_seen"),
                     serverAuthSchemeBucket: pendingMetadataFetchDiagnosticField(data: data, key: "server_claim_auth_scheme_bucket", defaultValue: "missing"),
                     serverTokenValidationBucket: pendingMetadataFetchDiagnosticField(data: data, key: "server_claim_token_validation_bucket", defaultValue: "not_reached"),
                     serverAuthenticatedUserBucket: pendingMetadataFetchDiagnosticField(data: data, key: "server_claim_authenticated_user_bucket", defaultValue: "not_reached"),
                     serverBoundSenderBucket: pendingMetadataFetchDiagnosticField(data: data, key: "server_claim_bound_sender_bucket", defaultValue: "not_checked"),
                     serverBoundDeviceBucket: pendingMetadataFetchDiagnosticField(data: data, key: "server_claim_bound_device_bucket", defaultValue: "not_checked"))
    }

    private static func pendingMetadataFetchDiagnosticField(data: Data, key: String, defaultValue: String) -> String {
        guard let payload = try? JSONSerialization.jsonObject(with: data) as? [String: Any] else {
            return defaultValue
        }
        let diagnostics = payload["diagnostics"] as? [String: Any]
        let value = diagnostics?[key] as? String ?? payload[key] as? String ?? defaultValue
        return redactedBucketValue(value, defaultValue: defaultValue)
    }

    private static func pendingMetadataFetchDiagnosticBool(data: Data, key: String) -> Bool {
        guard let payload = try? JSONSerialization.jsonObject(with: data) as? [String: Any] else {
            return false
        }
        let diagnostics = payload["diagnostics"] as? [String: Any]
        return diagnostics?[key] as? Bool ?? payload[key] as? Bool ?? false
    }

    private static func redactedBucketValue(_ value: String, defaultValue: String) -> String {
    ...
    static func recordReceiverRemoteParticipantRuntimeObservation(participantCountBucket: String,
        ...
        summary.recordRemoteAudioLivenessObservation(participantSeen: true,
                                                     ...
                                                     livenessObserved: livenessObserved)
        let shouldReleaseLease = summary.remoteParticipantObservationWaitCompleted
        let releaseReason = summary.remoteParticipantObservationFinalClassification
        if shouldReleaseLease {
            remoteParticipantObservationWindowID = nil
